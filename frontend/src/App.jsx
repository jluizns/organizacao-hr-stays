...
export default function App() {
  ...
  // --- LÓGICA DE FILTRAGEM AVANÇADA POR DATA ---
  ...
  return (
    <div className="min-h-screen p-3 font-sans md:p-6 bg-slate-900 text-slate-100">
      ...
      {/* CARDS DE RESUMO - Grid responsiva de 2 colunas no celular e 4 no PC */}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="p-4 border shadow-lg md:p-6 lg:col-span-2 bg-slate-800 rounded-xl border-slate-700">
          
          {/* PAINEL DE FILTROS AVANÇADOS */}
          <div className="p-3 mb-4 space-y-3 border rounded-xl bg-slate-900/60 border-slate-700/60">
